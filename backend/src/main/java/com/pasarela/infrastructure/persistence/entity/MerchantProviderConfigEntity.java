...
@Entity
@Table(
        name = "merchant_provider_configs",
        uniqueConstraints = @UniqueConstraint(name = "uq_merchant_provider", columnNames = {"merchant_id", "provider"})
)
public class MerchantProviderConfigEntity {
    @Id
